...
TOPIC_KEYWORDS: dict[str, set[str]] = {
    "教学内容": {"内容", "知识点", "难度", "重点", "案例", "PPT", "复习", "概念"},
    "授课方式": {"讲课", "讲解", "语速", "互动", "解释", "清楚", "课堂", "氛围"},
    "作业任务": {"作业", "任务", "练习", "提交", "批改", "报告"},
    "考试安排": {"考试", "范围", "题型", "复习", "成绩", "重点"},
    "实验实践": {"实验", "环境", "代码", "配置", "运行", "报错", "示例", "实践"},
    "学习收获": {"收获", "帮助", "能力", "理解", "提高", "有用"},
}
